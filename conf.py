# -*- coding: utf-8 -*-
#
# FlavourSys Strawberry documentation build configuration file, created by
# sphinx-quickstart on Fri Nov 23 14:41:47 2012.
#
...
html_title = 'FlavourSys %(product)s Manual' % branding
...
# of the sidebar.
#html_logo = None
html_logo = 'images/flavoursys_logo_190x37.png'
...
man_pages = [
    ('index', 'flavoursysmanual', u'FlavourSys Manual',
     [u'FlavourSys'], 1)
]
...
texinfo_documents = [
    ('index', 'FlavourSys', u'FlavourSys %(product)s Manual' % branding,
        u'FlavourSys', 'FlavourSys', 'Manual of FlavourSys $(product)s' % branding,
        'Documentation'),
]
...
pdf_documents = [
('index', u'FlavourSysStrawberry4UserManual', u'FlavourSys Strawberry 4 User Manual', u'FlavourSys'),
]
